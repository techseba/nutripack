    ...
    <template x-for="toast in toasts" :key="toast.id">
        <div class="mb-3 pointer-events-auto" x-transition:enter="transform ease-out duration-300 transition"
            ...
            <div class="flex items-center gap-3 px-4 py-3 rounded-xl shadow-2xl border backdrop-blur-md"
                :class="{
                    'bg-emerald-500 text-white border-emerald-500/50': toast.type === 'success',
                    'bg-red-500 text-white border-red-500/50': toast.type === 'error',
                    'bg-amber-500 text-white border-amber-600/30': toast.type === 'warning',
                    'bg-blue-500 text-white border-blue-600/30': toast.type === 'info'
                }">
