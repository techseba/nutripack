    ...
    <div x-show="selectConfirmModal" x-transition:enter="transition ease-out duration-300"
        ...
        <div x-show="selectConfirmModal" x-transition:enter="transition ease-out duration-300"
            ...
            <div class="text-center space-y-4">
                ...
                <!-- Title -->
                <h2 class="text-lg font-semibold text-slate-700">Are you sure?</h2>
                ...
                <div class="flex justify-center gap-3 pt-2">
                    ...
                    <x-ui.button variant="danger" size="lg" @click="$wire.selectMeal(itemId)">Confirm</x-ui.button>
                </div>
            </div>
        </div>
