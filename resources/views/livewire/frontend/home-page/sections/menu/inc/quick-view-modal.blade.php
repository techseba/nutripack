            ...
            <div class="md:col-span-3 p-8 space-y-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="p-4 bg-slate-50 rounded-2xl">
                        ...
                        <p class="text-xl font-bold text-slate-800">{{ $this->protein }}</p>
                    </div>

                    <div class="p-4 bg-slate-50 rounded-2xl">
                        <p class="text-[10px] font-black text-slate-400 uppercase mb-1">Carbs</p>
                        <p class="text-xl font-bold text-slate-800">{{ $this->carbs }}</p>
                    </div>

                    <div class="p-4 bg-slate-50 rounded-2xl">
                        <p class="text-[10px] font-black text-slate-400 uppercase mb-1">Fat</p>
                        <p class="text-xl font-bold text-slate-800">{{ $this->fat }}</p>
                    </div>

                    <div class="p-4 bg-slate-50 rounded-2xl">
                        <p class="text-[10px] font-black text-slate-400 uppercase mb-1">Fiber</p>
                        <p class="text-xl font-bold text-slate-800">{{ $this->fiber }}</p>
                    </div>
