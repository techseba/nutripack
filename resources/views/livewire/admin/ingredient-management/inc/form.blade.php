<x-modal.form isFileUpload isEdit="{{ $this->isEdit }}" size="lg">
    ...
    <div class="grid grid-cols-2 gap-x-5">
        ...
        <div class="space-y-5">
            ...
            @if ($isEdit)
                <x-form.field-select label="Allergen indicator" model="allergen_indicator">
                    <option value="">Select</option>
                    <option value="contains_allergen">Contains Allergen</option>
                    <option value="no_allergen">No Allergen</option>
