<x-modal.single-view size="md">
    <div class="overflow-x-auto overflow-y-hidden scrollbar-custom max-w-full">
        <table class="w-full">
            ...
            <x-table.tr>
                <x-table.th thead>min calories</x-table.th>
                <x-table.td>{{ round($this->min_calories) }} kcal</x-table.td>
            </x-table.tr>

            <x-table.tr>
                <x-table.th thead>max calories</x-table.th>
                <x-table.td>{{ round($this->max_calories) }} kcal</x-table.td>
            </x-table.tr>
