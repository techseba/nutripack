    ...
    <table class="w-full">
        <thead>
            <x-table.tr thead>
                ...
                <x-table.th>Day of Week</x-table.th>
        ...
        <tbody>
            @forelse ($this->rows as $row)
                <x-table.tr>
                    ...
                    <x-table.td>{{$row->dietPlan->name}}</x-table.td>
                    <x-table.td>{{$row->planCategory->name}}</x-table.td>
                    <x-table.td>{{$row->days_of_week}} days</x-table.td>
                    <x-table.td>{{$row->price}} BHD</x-table.td>
