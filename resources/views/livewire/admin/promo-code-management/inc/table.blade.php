    ...
    <table class="w-full">
        <thead>
            <x-table.tr thead>
                ...
                <x-table.th>Promo code</x-table.th>
        ...
        <tbody>
            @forelse ($this->rows as $row)
                <x-table.tr>
                    ...
                    <x-table.td>{{ $row->promo_code }}</x-table.td>
                    <x-table.td class="capitalize">{{ $row->type }}</x-table.td>
                    <x-table.td>{{ $row->value }}</x-table.td>
                    <x-table.td><x-widget.date :value="$row->expires_at" /></x-table.td>
