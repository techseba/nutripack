    ...
    <table class="w-full">
        <thead>
            <x-table.tr thead>
                ...
                <x-table.th>diet plan type</x-table.th>
        ...
        <tbody>
            @forelse ($this->rows as $row)
                <x-table.tr>
                    ...
                    <x-table.td>
                        @if($row->image)
                            <flux:avatar size="sm" src="{{ asset('storage/' . $row->image) }}" />
                        @else
                    ...
                    <x-table.td>{!! highlight($row->diet_plan_type, $this->search) !!}</x-table.td>
                    <x-table.td>
                        <span style="background-color: {{ $row->color }};" class="px-3 py-1 rounded text-white">
                            {{ $row->color }}
                        </span>
                    </x-table.td>
